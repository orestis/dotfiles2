...
local base_dark = hsl("#1c1c1c")
local base_light = hsl("#d0d0d0")
local base_gray_dark = hsl("#808080")
local base_gray_light = hsl("#d0d0d0")
local builtin = hsl("#00afaf")
local green_dark = hsl("#5faf5f")
local green_light = hsl("#afd700")
local orange_light = hsl("#ffaf00")
local orange_normal = hsl("#d7af5f")
local orange_dark = hsl("#d7875f")
local blue = hsl("#5fafd7")

local theme = lush(function()

  return {
    Normal { bg = base_dark, fg = base_light },
    LineNr       { bg = Normal.bg, fg = base_gray_dark}, -- Line number for ":number" and ":#" commands, and when 'number' or 'relativenumber' option is set.
    ...
    Constant       { fg = orange_normal }, -- (preferred) any constant
    ...
    Function       { }, -- function name (also: methods for classes)
    FunctionBuiltin       { fg = builtin, gui = "bold" }, -- function name (also: methods for classes)
    clojureSymbol {},
    clojureSpecial { FunctionBuiltin },
    TSFunction {FunctionBuiltin},
    clojureKeyword { fg = green_light },
    clojureMacro { fg = builtin },
    clojureFunc { fg = builtin },
    clojureCond { fg = builtin },
    clojureParen { fg = blue },
    TSPunctBracket { clojureParen },
    TSParameter { Normal },
    TSType {clojureKeyword},
